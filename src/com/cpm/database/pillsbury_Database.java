...
public class pillsbury_Database extends SQLiteOpenHelper {
	...
	public static final String DATABASE_NAME = "PILLSBURY_DATABASE";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(CommonString.CREATE_TABLE_PROMOTIONPOST);
	...
	public void AddTraining(Long mid, String storeid, String salespersonid,
			String salesperson, String trainingid, String training) {
		...
		try {
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
					...
					values1.put(CommonString.KEY_EXPIRING_DATE,
							data.get(save_listDataHeader.get(i)).get(j)
									.getExpiring_date());
					...
					db.insert(CommonString.TABLE_OENGINGSTOCK_DATA,
							null, values1);
	...
	public void InsertPromotionData(long mid, String storeid,
			HashMap<PromotionTrackingBean, List<PromotionTrackingBean>> data,List<PromotionTrackingBean> save_listDataHeader) {
		...
		try {
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				long l = db.insert(CommonString.TABLE_INSERT_HEADER_PROMOTION_DATA,
						null, values);
				...
				for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
					...
					values1.put(CommonString.KEY_PROMOTION_NAME,
							data.get(save_listDataHeader.get(i)).get(j)
									.getPromotion_name());
					values1.put(CommonString.KEY_PROMOTION_AVAIL,
							data.get(save_listDataHeader.get(i)).get(j)
									.getPromotion_avail());
					
					values1.put(CommonString.KEY_REMARKS,
							data.get(save_listDataHeader.get(i)).get(j)
									.getRemark());
					...
					values1.put(CommonString.KEY_REASON_ID,
							data.get(save_listDataHeader.get(i)).get(j)
									.getReasonid());
					
					values1.put(CommonString.KEY_REASON,
							data.get(save_listDataHeader.get(i)).get(j)
									.getReason());
					...
					db.insert(CommonString.TABLE_INSERT_PROMOTION_DATA,
							null, values1);
	...
	public void deleteAssetData(String storeid) {
		...
		try {
			...
			db.delete(CommonString.TABLE_INSERT_HEADER_ASSET_DATA,
					CommonString.KEY_STORE_CD + "='" + storeid + "'", null);
	...
	public void InsertAssetData(long mid, String storeid,
		...
		try {
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				long l = db.insert(CommonString.TABLE_INSERT_HEADER_ASSET_DATA,
						null, values);
...
//									.getSku_name());
					...
					values1.put(CommonString.KEY_ASSET_NAME,
							data.get(save_listDataHeader.get(i)).get(j)
									.getAsset_name());
					
					values1.put(CommonString.KEY_ASSET_CD,
							data.get(save_listDataHeader.get(i)).get(j)
									.getAsset_cd());
...
//									.getSku_cd());
					...
					values1.put(CommonString.KEY_ASSET_AVAIL,
							data.get(save_listDataHeader.get(i)).get(j)
									.getAsset_avail());
					...
					db.insert(CommonString.TABLE_INSERT_ASSET_DATA,
							null, values1);
	...
	public void InsertStockRecievedlistData(long mid, String storeid,
			HashMap<MidDayRecievedStockBean, List<MidDayRecievedStockBean>> data,List<MidDayRecievedStockBean> save_listDataHeader) {
		...
		try {
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				long l = db.insert(CommonString.TABLE_INSERT_STOCKRECIEVED_DATA,
						null, values);
				...
				for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
					...
					db.insert(CommonString.TABLE_MIDDAYSTOCK_RECIEVED_DATA,
							null, values1);
			...
			for (int i = 0; i < save_listDataHeader.size(); i++) {
				...
				for (int j = 0; j < data.get(save_listDataHeader.get(i)).size(); j++) {
					...
					values1.put(CommonString.KEY_SKU_CD,
							data.get(save_listDataHeader.get(i)).get(j)
									.getSKU_CD());
					values1.put(CommonString.KEY_STOCK,
							data.get(save_listDataHeader.get(i)).get(j)
									.getStock());
	...
	public void InsertTrainigTopics(downloadtraingtopicsgettersetter data) {

		db.delete(CommonString.TABLE_TRAINING_TOPICS, null, null);
		ContentValues values = new ContentValues();
		...
		try {
			...
			for (int i = 0; i < data.gettopic_cd().size(); i++) {
				...
				values.put(CommonString.KEY_TOPIC_CD, data.gettopic_cd().get(i));
				values.put(CommonString.key_TOPIC, data.gettopic().get(i));

				db.insert(CommonString.TABLE_TRAINING_TOPICS, null, values);
...
//				}
	...
	public void InsertCallsBetween12To3Data(Long mid, String totalCalls, String productiveCals, String punchTime,String storeid){
		...
		try {
			...
			Log.d("Database Exception while insert calls between 12 to 3 tracker data", e.getMessage());
		}
		...
		try {
			...
			if (dbcursor != null) {
				...
				for (int i = 0; i < numrows; i++) {
					...
					Rights=(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_RIGHTS)));
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					sb.setCategory(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_CATEGORY_CODE)));
//					sb.setTam(dbcursor.getString(dbcursor
//							.getColumnIndexOrThrow(CommonString.KEY_STORE_TAM)));
	...
	public ArrayList<PromotionTrackingBean> getPromotionTrackData(String Store_id){
		...
		try {
			...
			dbcursor = db.rawQuery("SELECT DISTINCT BRAND , BRAND_CD from Mapping_PromotionPost_data " +
					" WHERE STORE_CD ="+ Store_id+ " ORDER BY BRAND_SEQUENCE ASC", null);
	...
	public ArrayList<AssetTrackerBean> getAssetTrackData(String Store_id){
		...
		try {
			...
			dbcursor = db.rawQuery("SELECT DISTINCT BRAND , BRAND_CD from Mapping_AssetPost_data " +
					" WHERE STORE_CD ="+ Store_id + " GROUP BY BRAND", null);
	...
	public ArrayList<ClosingStockBean> getClosingStock(String Store_id){
		...
		// getInsertedData
				public ArrayList<PromotionTrackingBean> getInsertedPromotionComplianceData(String storeid) {
					...
					try {
						dbcursor = db.rawQuery("SELECT  * from "
								+ CommonString.TABLE_INSERT_HEADER_PROMOTION_DATA + " where "
								+ CommonString.key_STORE_CD + " = '" + storeid + "'", null);
				...
				public ArrayList<AssetTrackerBean> getInsertedAssetComplianceData(String storeid) {
					...
					try {
						dbcursor = db.rawQuery("SELECT  * from "
								+ CommonString.TABLE_INSERT_HEADER_ASSET_DATA + " where "
								+ CommonString.key_STORE_CD + " = '" + storeid + "'", null);
...
//										.getColumnIndexOrThrow(CommonString.KEY_SKU_CD)));
			...
			try {
				...
				if (dbcursor != null) {
					...
					while (!dbcursor.isAfterLast()) {
						...
						sb.setListedFlag(dbcursor.getString(dbcursor
								.getColumnIndexOrThrow(CommonString.KEY_LISTED_CHECKBOX)));
			...
			if (dbCursor != null) {
				...
				while (!dbCursor.isAfterLast()) {
					...
					bean.setTotalCalls(dbCursor.getString(dbCursor
							.getColumnIndexOrThrow(CommonString.KEY_TOTAL_CALLS3to6)));
					
					bean.setProductiveCalls(dbCursor.getString(dbCursor
							.getColumnIndexOrThrow(CommonString.KEY_PRODUCTIVE_CALLS3to6)));
					
					bean.setPosSale(dbCursor.getString(dbCursor
							.getColumnIndexOrThrow(CommonString.KEY_POS_SALE)));
	...
	public long UpdateCoverageData(CoverageBean data, String visitDate,
			String Storeid) {
...
//				values.put(CommonString.KEY_SKU, data.getSKU().get(i));
			...
			Log.d("Database Exception while Insert sku post data ",ex.getMessage());
		}
		...
		try {
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					sb.setImage((((dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_IMAGE))))));
					sb.setOutlook_Remark((((dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_OUTLOOK_REMARK))))));
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							...
							"SD ON CD._id=SD.COMMONID WHERE CD.STORE_CD= '"+ storeId +"' AND SD.LISTED_CHECKBOX = 'true' ", null);
	...
	public ArrayList<AssetTrackerBean> getAssetDataUpload(String storeId) {
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							"SELECT SD.ASSET, SD.ASSET_CD, SD.PROMOTION_AVAIL, SD.REMARKS, SD.actualCount, SD.REASON_ID , SD.IMAGE, CD.BRAND_CD " +
							"FROM INSERT_HEADER_ASSET_DATA CD INNER JOIN INSERT_ASSET_DATA SD ON CD._id=SD.COMMONID WHERE CD.STORE_CD= '"
									+ storeId + "'", null);
			...
			if (dbcursor != null) {
				...
				/*	sb.setSku_name(dbcursor.getString(dbcursor
					...
					sb.setAsset_cd(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_ASSET_CD)));
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							...
							"WHERE CD.STORE_CD= '"
									+ storeId + "' AND SD.LISTED_CHECKBOX = 'true'", null);
		...
		try {
			...
			if (dbcursor != null) {
				...
				while (!dbcursor.isAfterLast()) {
					...
					sb.setFromTime(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_FROM_TIME)));
					
					sb.setToTime(dbcursor.getString(dbcursor
							.getColumnIndexOrThrow(CommonString.KEY_TO_TIME)));
		...
		try {
			...
			dbcursor = db
					.rawQuery(
							...
							"WHERE CD.STORE_CD= '"+ storeId + "' AND LISTED_CHECKBOX = 'true' ", null);
		...
		try {
			...
			if (cursor != null) {
				...
				while (!cursor.isAfterLast()) {
					...
					sb.setAllow_pog(cursor.getString(cursor
							.getColumnIndexOrThrow(CommonString.KEY_ALLOW_POG)));
					
					sb.setAllow_shelf(cursor.getString(cursor
							.getColumnIndexOrThrow(CommonString.KEY_ALLOW_SHELF)));
					
					sb.setAllow_signage(cursor.getString(cursor
							.getColumnIndexOrThrow(CommonString.KEY_ALLOW_SIGNAGE)));
	...
	try {
		...
		if (cursor != null) {
			...
			while (!cursor.isAfterLast()) {
				...
				sb.setCategory_id(cursor.getString(cursor
						.getColumnIndexOrThrow(CommonString.KEY_CATEGORY_CD)));
				
				sb.setCategory(cursor.getString(cursor
						.getColumnIndexOrThrow(CommonString.KEY_CATEGORY)));
...
public void InsertCompetitionData(long mid, String store_id,
	...
	try {
		...
		for (int i = 0; i < categorylist.size(); i++) {
			...
			values.put(CommonString.KEY_QUANTITY, categorylist.get(i)
					.getQuantity());
	...
	try {
		...
		if (cursordata != null) {
			...
			while (!cursordata.isAfterLast()) {
				...
				sb.setCategory(cursordata.getString(cursordata
						.getColumnIndexOrThrow(CommonString.KEY_CATEGORY)));
				
							
				sb.setPOSM(cursordata.getString(cursordata
						.getColumnIndexOrThrow(CommonString.Key_POSM)));
				sb.setPOSM_CD(cursordata.getString(cursordata
