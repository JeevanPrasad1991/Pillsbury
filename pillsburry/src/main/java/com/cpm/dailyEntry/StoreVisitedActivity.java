    ...
    public void onButtonClick(View v) {
        switch (v.getId()) {
            case R.id.yes:
                ...
                if (mid == 0) {
                    intent = new Intent(getBaseContext(), StoreimageActivity.class);
                } else {
                    intent = new Intent(getBaseContext(), DailyEntryMenu.class);
                }
            ...
            case R.id.no:
                ...
                if (getMid() != 0) {
                    ...
                    builder.setMessage("Your all data will be deleted.")
                            ...
                            .setNegativeButton("Back", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog,
                                                            int id) {
                                            dialog.cancel();
                                            Intent i = new Intent(StoreVisitedActivity.this, StorelistActivity.class);
                                            startActivity(i);
                                            StoreVisitedActivity.this.finish();
                                        }
                                    });
                    ...
                    database.updateStoreStatusOnCheckout(store_id, visit_date, CommonString.KEY_N);
