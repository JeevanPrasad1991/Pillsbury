	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = inflater.inflate(R.layout.saleoutlooklist_inflater, null);

				holder.Idealfor = (TextView) convertView.findViewById(R.id.txt_idealFor);
				holder.lastmonthsale = (EditText) convertView.findViewById(R.id.lastmonthSale);
				holder.tilldateSale = (EditText) convertView.findViewById(R.id.tillDateSale);
				holder.salesOutlook = (EditText) convertView.findViewById(R.id.salesOutlook);
