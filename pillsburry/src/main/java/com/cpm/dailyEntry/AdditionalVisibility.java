...
//						quantity.setText("1");
    ...
    public class MyAdaptor extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.addtional_list, null);
                    ...
                    alertDialogBuilder.setMessage("Click Yes To Delete!").setCancelable(false)
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    // current activity
                                /*String  idd=list.get(position).getKey_id();
								Log.d("",idd);*/
								...
								listview.invalidateViews();*/
                                    String listid = list.get(position).getKey_id();
                                    db.deleteProductEntry(listid);
            ...
            holder.brand.setText(list.get(position).getCategory().toString());
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Are you sure you want to quit ?").setCancelable(false).setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent in = new Intent(AdditionalVisibility.this, DailyEntryMenu.class);
                        startActivity(in);
                        AdditionalVisibility.this.finish();
