		...
		builder.setMessage("New Update Available.")
				...
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						...
						editor.clear();
						editor.commit();
						new File("/data/data/com.cpm.pillsbury/databases/PILLSBURY_DATABASE").delete();
				...
				.setNegativeButton("Cancel",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								...
								Intent i = new Intent(AutoupdateActivity.this, MainMenuActivity.class);
								startActivity(i);
	...
	private class DownloadTask extends AsyncTask<Void, Data, String> {
		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				final AlertMessage message = new AlertMessage(AutoupdateActivity.this, AlertMessage.MESSAGE_EXCEPTION, "download", e);
				...
				final AlertMessage message = new AlertMessage(AutoupdateActivity.this, AlertMessage.MESSAGE_SOCKETEXCEPTION, "update", e);
				runOnUiThread(new Runnable() {
